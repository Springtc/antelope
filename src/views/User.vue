<template lang="html">
    ...
    <div class="car">
        <header class="header">
            ...
            <span>{{userInfoVo.userInfo.userName}}</span>
        </header>
        ...
        <div class="main">
            ...
            <section class="my-vip">
                <router-link class="my-vip-top ho" :to="{ name: '个人信息'}">
                ...
                <span class="icon2-vip">
                    ...
                    <p>
                        <span>个人资料</span><i class="icon-go"></i>
                    </p>
                </router-link>
            </section>
            <section class="my-vip">
                <router-link class="my-vip-bottom ho" :to="{ name: '礼券'}">
                    <div>
                        <span class="icon2-money"></span>
                    </div>
                    <p>
                        <span>羚羊的礼物</span><i class="icon-go"></i>
                    </p>
                </router-link>
                <router-link class="my-vip-top ho" :to="{ name: '会员权益'}">
                    <div class="my-vip-top-div">
                <span class="icon2-vip">
                    <span class="path1"></span><span class="path2"></span><span class="path3"></span><span
                        class="path4"></span><span class="path5"></span><span class="path6"></span><span
                    ...
                    <p>
                        <span>羚羊俱乐部</span><i class="icon-go"></i>
                    </p>
                </router-link>
            </section>
            ...
            <section class="my-settle">
                <router-link :to="{ name: ''}" class="my-settle-top">
                    ...
                    <p>
                        <span>早餐助手</span><i class="icon-go"></i>
                    </p>
                </router-link>
            ...
            <section class="my-service">
                <router-link class="my-service-top" :to="{ name: ''}">
                    ...
                    <p>
                        <span>帮助和反馈</span><i class="icon-go"></i>
                    </p>
                </router-link>
