        ...
        methods: {
            ...
            login() {
                if (this.account !== "" && this.password !== "") {
                    this.$api.get(this.$store.state.wspserver.wspServer + '/userInfo/message/' + this.account + '/' + this.password).then(response => {
                        console.log(response.data.data.token);
                        this.$store.commit("CHANGE_TOKEN", response.data.data.token);
                        this.$store.commit("CHANGE_USER", response.data.data.id);
